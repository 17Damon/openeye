...
!function (e) {
  function t(n) {
    ...
    for (var c, l, s = 0, i = []; s < o.length; s++) {
      l = o[s], a[l] && i.push.apply(i, a[l]), a[l] = 0;
    }for (c in p) {
      e[c] = p[c];
    ...
    if (0 === a[e]) return n.call(null, t);if (void 0 !== a[e]) a[e].push(n);else {
      a[e] = [n];var r = document.getElementsByTagName("head")[0],
          o = document.createElement("script");o.type = "text/javascript", o.charset = "utf-8", o.async = !0, o.src = t.p + "" + e + ".chunk.js", r.appendChild(o);
    }
  }, t.m = e, t.c = r, t.p = "/dist/";
}([]);
